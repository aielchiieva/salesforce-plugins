...
public class SalesforceConnectionUtil {
   ...
   * primary is used to obtains sObjects describe results.
   *
  ...
  /**
   * Creates {@link AuthenticatorCredentials} instance using provided parameters.
   *
  ...
  /**
   * Creates {@link AuthenticatorCredentials} instance from provided {@link Configuration}.
   *
